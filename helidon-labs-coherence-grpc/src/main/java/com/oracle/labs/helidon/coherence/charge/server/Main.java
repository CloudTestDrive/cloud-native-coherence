...
public final class Main {
	...
	private static Config buildConfig() {
		...
		configSourcesToScan.add(ConfigSources.file("conf/coherence-charge-config.yaml"));
		configSourcesToScan.add(ConfigSources.file("conf/coherence-charge-network.yaml").optional().build());
		configSourcesToScan.add(ConfigSources.file("confsecure/coherence-charge-security.yaml").build());
