...
public final class Main {
	...
	private static Config buildConfig() {
		...
		configSourcesToScan.add(ConfigSources.file("conf/coherence-report-config.yaml"));
		configSourcesToScan.add(ConfigSources.file("conf/coherence-report-network.yaml").optional().build());
		configSourcesToScan.add(ConfigSources.file("confsecure/coherence-report-security.yaml").build());
